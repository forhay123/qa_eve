...
app.include_router(topic_questions.router, prefix="/api")
app.include_router(timetable.router, prefix="/api")
app.include_router(student_profile.router, prefix="/api")
app.include_router(attendance.router, prefix="/api")
app.include_router(test_exam.router, prefix="/api")
app.include_router(report_generator.router, prefix="/api")
app.include_router(personalization.router, prefix="/api")
app.include_router(teachers.router, prefix="/api")
app.include_router(parents.router, prefix="/api")
app.include_router(quizzes.router, prefix="/api/student", tags=["Quizzes"])
app.include_router(achievements.router, prefix="/api")
app.include_router(resources.router, prefix="/api")
app.include_router(classes.router, prefix="/api")
app.include_router(admin.admin_router, prefix="/api")
app.include_router(admin_progress.router, prefix="/api")
...
app.include_router(ask_me_anything.router, prefix="/api")
app.include_router(parent_dashboard_router.router, prefix="/api")
